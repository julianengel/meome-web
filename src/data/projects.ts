...
export const projects: Project[] = [
    ...
    },
    {
        ...
        status: 'MVP',
        metrics: '250k+ pipelines automated',
        logo: '/companies/pawdcast.png',
        website: 'pawdcast.net',
    ...
    },
    {
        ...
        status: 'MVP',
        metrics: '250k+ pipelines automated',
        logo: '/companies/domaindetails.png',
        website: 'domaindetails.io',
        industry: 'SaaA',
        founded: '2024',
        impact: [
            { metric: 'Pipelines Automated', value: '250k+' },
    ...
    },
    {
        ...
        status: 'MVP',
        metrics: '100k+ consultations delivered',
        logo: '/companies/ampawssadors.png',
